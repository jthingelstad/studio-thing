...
def main() -> None:
    ...
    build_parser.add_argument(
        "--prune", action="store_true", help="Remove archive files not in data/issues/"
    )

    subparsers.add_parser(
        "stats",
        help="Refresh apps/site/_data/stats.json (subscriber/premium counts + Stripe balance)",
    )
    ...
    publish_parser.add_argument(
        "--dry-run", action="store_true", help="Preview without touching Buttondown"
    )
